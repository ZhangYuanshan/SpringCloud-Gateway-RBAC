...
import com.imlehr.quizhub.utils.JGitUtils;
 ...
 */
@Service
public class GitInfoServiceImpl {

    private static final String prefix = "null";
    private static final String SUFFIX = ".git";
    private static final String CONFIG = "/home/lehr/GitRepo/team-quizhub/";
    ...
    public String createRepo(String owner, String repoName) {
        ...
        String s = "#!/bin/sh\n" +
                "\n" +
                "curl -d \"user=lehr\" http://localhost:9999/gitRepo/logs\n" +
                "\n" +
        ...
        String sshUrl = "lehr@localhost:GitRepo/" + owner + "/" + repoName + SUFFIX;
    ...
    public String onlineUpload(String owner, String repoName, String filename) {
        ...
        String remoteLocal = "lehr@localhost:GitRepo/"+owner+"/" + repoName +SUFFIX;
        ...
        JGitUtils.createFile("/home/lehr/GitRepo/"+owner+File.separator+temp+File.separator+filename,s);
